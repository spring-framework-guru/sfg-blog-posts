...
@RestController
@RequestMapping(value = "/api/v3/pets", produces = MediaType.APPLICATION_JSON_VALUE)
public class PetRestControllerV3 {

  private PetService petService;

  @Autowired
  public PetRestControllerV3(PetService petService) {
